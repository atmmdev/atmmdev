...
Canonical process for this Career Repository.

## Source of truth

- `resume/master.md` — full career documentation
- `projects/*.md` — project evidence
- Resume research links in master — **reference only**, never experience

## Positioning

Senior Fullstack Engineer (Frontend-focused, ~60/40)  
Primary stack: React · Next.js · TypeScript · Node.js · NestJS
...
1. Do not invent experience, metrics, or specialties.
2. Real experience > relevant experience > keywords.
3. Do not exaggerate Cloud, C#, or AI into specialist titles without evidence.
4. Avoid repeating the same claim across Summary / Experience / Projects.
