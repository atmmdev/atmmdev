...
Senior Frontend Engineer with 15+ years in software engineering and a 20+ years of foundation in UX/UI building digital products and web development. Specialized in React, Next.js, TypeScript, frontend architecture, Design Systems, and performance. I build enterprise interfaces that are fast, maintainable, and product-aware — from App Router architectures and component systems to API integration and accessibility-minded UI. Backend collaboration with Node.js/NestJS. Experience in global organizations including IBM, BairesDev, Globant, British Petroleum, CNN Brasil, and Cars.com.
...
Enterprise forestry operations portal (Suzano).
...
High-volume financial editorial platform.

- Implemented 29 custom Gutenberg/ACF blocks and conversion-oriented landing pages.
- Built editorial UI architecture across 11 custom post types.
- Supported AMP theme and content experiences for mobile monetization.
